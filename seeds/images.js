  ...
  return knex('images').del()
    .then(function () {
      ...
      return knex('images').insert([
        ...
        {id: 6, image_url: '', categories_id: 1},
        ...
        {id: 13, image_url: '', categories_id: 5},
        {id: 14, image_url: '', categories_id: 5},
        {id: 15, image_url: '', categories_id: 5},
        {id: 16, image_url: '', categories_id: 6},
        {id: 17, image_url: '', categories_id: 6},
        {id: 18, image_url: '', categories_id: 6},
